# -*- coding: utf-8 -*-
{
    'name': 'Startupos Platform Provisioning',
    'version': '19.0.1.0.0',
    'category': 'Tools',
    'summary': 'Platform operator: Tenant DB creation and module install',
    'description': '''
Platform operator: Tenant DB creation and module install
...
See https://thestartupos.com for the platform overview.
    ...
    'depends': ['base', 'startupos_platform_core'],
    'data': [
