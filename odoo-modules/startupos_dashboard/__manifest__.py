# -*- coding: utf-8 -*-
{
    'name': 'Startupos Dashboard',
    'version': '19.0.1.0.0',
    'category': 'Tools',
    'summary': 'Startup health dashboard (runway, MRR, pipeline)',
    'description': '''
Startup health dashboard (runway, MRR, pipeline)
...
See https://thestartupos.com for the platform overview.
    ...
    'depends': ['base', 'mail', 'web', 'sale_management', 'account', 'project'],
    'data': [],
    'demo': [],
    'installable': True,
    'application': False,
