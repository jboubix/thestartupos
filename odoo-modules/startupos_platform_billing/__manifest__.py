# -*- coding: utf-8 -*-
{
    'name': 'Startupos Platform Billing',
    'version': '19.0.1.0.0',
    'category': 'Tools',
    'summary': 'Platform operator: Stripe integration for tenant subscriptions',
    'description': '''
Platform operator: Stripe integration for tenant subscriptions
...
See https://thestartupos.com for the platform overview.
    ...
    'depends': ['base', 'startupos_platform_core', 'account_payment'],
    'data': [],
    'demo': [],
    'installable': True,
    'application': False,
